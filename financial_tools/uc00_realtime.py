...
class Uc00Realtime(QObject):
    ...
    def __init__(self, start_time_hours=72):
        ...
        self.instrument = "uc00.sg"  # 美元兑人民币离岸汇率代码
...
if __name__ == "__main__":
    ...
    uc00 = Uc00Realtime(start_time_hours=240)
    uc00.register_callback(on_data_updated)
    print("启动美元兑人民币离岸汇率实时数据获取...")
    uc00.start()
