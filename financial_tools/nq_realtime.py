...
class NqRealtime(QObject):
    ...
    def __init__(self, start_time_hours=240):
        ...
        self.instrument = "nq.cme"  # 纳斯达克100期货代码
...
if __name__ == "__main__":
    ...
    nq = NqRealtime(start_time_hours=240)
    nq.register_callback(on_data_updated)
    print("启动纳斯达克100期货实时数据获取...")
    nq.start()
