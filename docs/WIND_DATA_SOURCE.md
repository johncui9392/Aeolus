...
Aeolus 通过 [wind-mcp-skill](https://gitee.com/wind_info/wind-skills)（万得官方技能）接入 Wind 金融数据，技能目录为 `skills/Wind_FinData/`，在界面中显示为 **「万得金融数据查询」**。
...
| 技能数量 | 多数 `skills/` 插件 | 当前为 `Wind_FinData` |
...
扩展更多 Wind 工具（K 线、公告、宏观等）可参考上游 [wind-skills 文档](https://gitee.com/wind_info/wind-skills) 与 `skills/Wind_FinData/SKILL.md`。
